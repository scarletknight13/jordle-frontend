  ...
  return (
    <Dialog className="TutorialModal" visible={tutorialVisible} onHide={() => setTutorialVisible(false)}
        ...
        <ul style={{listStyle: 'none'}}>
          <li><p className="tutorial-paragraph">Every word must be a valid 5 letter word.</p></li>
          <li><p className="tutorial-paragraph">The color of the tiles will change to show how close your guess was to the word.</p></li>
        </ul>
